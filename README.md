...
- SQLITE na pas de limitation de stockage cela dépend de la capacité de votre disque dur idéal serait un disque dur en téraocté se quit ferait la base de donné en illimité la base de donné SQLITE peut  étre utiliser partout sur les systéme enbarquer de robotique en python ou autre language
